...
import enfantResolve from './enfant-routing-resolve.service';
...
describe('Enfant routing resolve service', () => {
  ...
  describe('resolve', () => {
    it('should return IEnfant returned by find', async () => {
      // GIVEN
      ...
      await new Promise<void>(resolve => {
        TestBed.runInInjectionContext(() => {
          enfantResolve(mockActivatedRouteSnapshot).subscribe({
            next(result) {
              // THEN
    ...
    it('should route to 404 page if data not found in server', async () => {
      // GIVEN
      jest.spyOn(service, 'find').mockReturnValue(of(new HttpResponse<IEnfant>({ body: null })));
      mockActivatedRouteSnapshot.params = { id: 123 };
