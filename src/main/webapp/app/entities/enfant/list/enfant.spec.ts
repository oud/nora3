...
import { sampleWithRequiredData } from '../enfant.test-samples';
...
describe('Enfant Management Component', () => {
  ...
  it('should call load all on init', () => {
    ...
    expect(comp.enfants()[0]).toEqual(expect.objectContaining({ id: 8992 }));
  });

  describe('trackId', () => {
    it('should forward to enfantService', () => {
      const entity = { id: 8992 };
      jest.spyOn(service, 'getEnfantIdentifier');
      const id = comp.trackId(entity);
      expect(service.getEnfantIdentifier).toHaveBeenCalledWith(entity);
