...
import { StatutDeleteDialog } from './statut-delete-dialog';

describe('Statut Management Delete Component', () => {
  let comp: StatutDeleteDialog;
  let fixture: ComponentFixture<StatutDeleteDialog>;
  ...
  beforeEach(() => {
    ...
    fixture = TestBed.createComponent(StatutDeleteDialog);
