...
import { sampleWithRequiredData } from '../demarche.test-samples';
import { DemarcheService } from '../service/demarche.service';

import { Demarche } from './demarche';

describe('Demarche Management Component', () => {
  let comp: Demarche;
  let fixture: ComponentFixture<Demarche>;
  ...
  beforeEach(() => {
    ...
    fixture = TestBed.createComponent(Demarche);
  ...
  it('should call load all on init', () => {
    ...
    expect(comp.demarches()[0]).toEqual(expect.objectContaining({ id: 7199 }));
  });

  describe('trackId', () => {
    it('should forward to demarcheService', () => {
      const entity = { id: 7199 };
      jest.spyOn(service, 'getDemarcheIdentifier');
      const id = comp.trackId(entity);
      expect(service.getDemarcheIdentifier).toHaveBeenCalledWith(entity);
