...
import { sampleWithRequiredData } from '../situation.test-samples';
...
describe('Situation Management Component', () => {
  ...
  it('should call load all on init', () => {
    ...
    expect(comp.situations()[0]).toEqual(expect.objectContaining({ id: 28437 }));
  });

  describe('trackId', () => {
    it('should forward to situationService', () => {
      const entity = { id: 28437 };
      jest.spyOn(service, 'getSituationIdentifier');
      const id = comp.trackId(entity);
      expect(service.getSituationIdentifier).toHaveBeenCalledWith(entity);
