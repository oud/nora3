...
import { SituationDeleteDialog } from './situation-delete-dialog';

describe('Situation Management Delete Component', () => {
  let comp: SituationDeleteDialog;
  let fixture: ComponentFixture<SituationDeleteDialog>;
  ...
  beforeEach(() => {
    ...
    fixture = TestBed.createComponent(SituationDeleteDialog);
