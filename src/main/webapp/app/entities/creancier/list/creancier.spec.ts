...
import { sampleWithRequiredData } from '../creancier.test-samples';
import { CreancierService } from '../service/creancier.service';

import { Creancier } from './creancier';

describe('Creancier Management Component', () => {
  let comp: Creancier;
  ...
  it('should call load all on init', () => {
    ...
    expect(comp.creanciers()[0]).toEqual(expect.objectContaining({ id: 32390 }));
  });

  describe('trackId', () => {
    it('should forward to creancierService', () => {
      const entity = { id: 32390 };
      jest.spyOn(service, 'getCreancierIdentifier');
      const id = comp.trackId(entity);
      expect(service.getCreancierIdentifier).toHaveBeenCalledWith(entity);
