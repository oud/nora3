...
import { sampleWithRequiredData } from '../debiteur.test-samples';
...
describe('Debiteur Management Component', () => {
  ...
  it('should call load all on init', () => {
    ...
    expect(comp.debiteurs()[0]).toEqual(expect.objectContaining({ id: 18158 }));
  });

  describe('trackId', () => {
    it('should forward to debiteurService', () => {
      const entity = { id: 18158 };
      jest.spyOn(service, 'getDebiteurIdentifier');
      const id = comp.trackId(entity);
      expect(service.getDebiteurIdentifier).toHaveBeenCalledWith(entity);
